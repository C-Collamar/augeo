...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest' && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    **/
    ...
    try {
        ...
        $description = 'User: <a href="http://localhost/augeo/admin/parent_admin/pages/customers/info/?account_id='.$account_id_session.'"> '.$account_id_session.' </a>-- Created an item with item id <a href="http://localhost/augeo/admin/parent_admin/pages/items/info/?id='.$id_for_log.'">'.$id_for_log.' </a>';

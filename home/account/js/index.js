...
//start up process when page is loaded
$(document).ready(function(){
// showing modal if user is new
        if($('#new_user').val() == 1){
              $("#myModal").modal('show');
}
// uploading image
        $("#but_upload").click(function(){
          $(this).val("Updating Profile Pic...");
                ...
                if(extension == "JPG" || extension == "JPEG"){  // if image is in JPG or JPEG format, update profile image
                ...
                else{ // return error msg if file is not in JPG or JPEG
                      $("#error_pic").css({color: 'red'});
...
$(document).ready(function() {
        var id = $("#account_id_session").val(); // getting account id session to identify user and get all data

    ...
    <div class="container" style="padding-top: 20px">
        <div class="row">
            ...
            <div class="col-sm-7">
                ...
                <h3>Note:</h3><br>
                <p>If you're unable to pay within 5 days, your Order Will Be VOID!</p><br><br>

                <div style="text-align: center">

                    <div style="display: inline-block">
                         <a href='./start.php?deal_id=<?php echo $deal_id; ?>&'><img src="http://localhost/augeo/global/img/checkout-logo-large.png" alt="Check out with PayPal" /></a>
                    </div>
                </div>
            </div>
        </div>

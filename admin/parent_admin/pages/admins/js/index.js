...
function test(search) {
    ...
    $('#pagination').on('click', 'a', function(e) { // When click on a 'a' element of the pagination div
        ...
        $('#data_admin').html('<img src="design/loader-small.gif" alt="" />'); // Display a processing icon
        ...
        $.ajax({ // jQuery Ajax
            ...
            success: function(data) {
                $('#data_admin').html(data.data); // We update the data_admin DIV with the article list

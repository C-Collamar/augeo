...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if(isset($_POST['profile_img'])) {
		...
		if($uploadOk) {
			move_uploaded_file($_FILES["profile_img"]["tmp_name"], $target_dir.$_SESSION['admin_id'].'.'.$fileType);
		}
		else {
	...
	$result = mysqli_query($conn,
		"UPDATE augeo_administration.admin ".
		"SET ".
			"f_name = '$f_name', ".
			"m_name = '$m_name', ".
			"l_name = '$l_name', ".
		...
		"WHERE account_id = ".$_SESSION['admin_id']
	);
